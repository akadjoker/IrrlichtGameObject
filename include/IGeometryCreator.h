...
public:
	...
	*/
	virtual IMesh* createCubeMesh(const core::vector3df& size, ECUBE_MESH_TYPE type = ECMT_1BUF_12VTX_NA) const =0;
	virtual IMesh* createCubeMesh(ECUBE_MESH_TYPE type = ECMT_1BUF_12VTX_NA) const =0;
	...
	*/
    ...
    virtual IAnimatedMesh* importMesh(const char* filename) const=0;
