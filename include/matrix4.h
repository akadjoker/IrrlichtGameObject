...
namespace core
{
	...
	class CMatrix4
	{
		public:
			...
			CMatrix4(const CMatrix3<T>& other);
			...
			inline CMatrix3<T> ToMatrix3() const;
	...
	template <class T>
	inline CMatrix4<T>::CMatrix4(const CMatrix3<T>& other)
	{
	...
	template <class T>
	inline CMatrix3<T> CMatrix4<T>::ToMatrix3() const
    {
       return CMatrix3<T>(
          M[0],M[1],M[2],
          M[4],M[5],M[6],
