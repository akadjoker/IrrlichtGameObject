...
//static s32 ReferenceCounter;
	...
	*/
	...
	public:
		...
		//! Constructor.
		IReferenceCounted()
			: DebugName("Object Root"),ReferenceCounter(1)
		{
		...
		SDL_Log("[OBJECT] Add  %s %d .",DebugName,ReferenceCounter);
		...
		bool drop() const
		{
			...
			{
				delete this;
			//	SDL_Log("[OBJECT] Delete  %s %d .",DebugName,ReferenceCounter);
				return true;
			}


			SDL_Log("[OBJECT] unreference  [%s %d].",DebugName,ReferenceCounter);
			return false;
		}
