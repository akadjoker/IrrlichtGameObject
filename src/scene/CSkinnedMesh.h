...
namespace scene
{
	...
	public:
		...
		void recoverJointsFromMesh(core::array<IGameObject*> &jointChildSceneNodes);

		//! Tranfers the joint data to the mesh
		void transferJointsToMesh( core::array<IGameObject*> &jointChildSceneNodes);

		//! Tranfers the joint hints to the mesh
		void transferOnlyJointsHintsToMesh( core::array<IGameObject*> &jointChildSceneNodes);

		//! Creates an array of joints from this mesh as children of node
		void addJoints(core::array<IGameObject*> &jointChildSceneNodes,IGameObject* node);
